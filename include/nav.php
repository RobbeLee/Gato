...
<div class="user-nav" id="user-nav">
    ...
    <div class="user-nav__body">
        ...
        <a href="<?php if ($subFolder) echo "../"; ?>u/<?php echo strtolower(htmlspecialchars($_SESSION['username'])); ?>#posts" title="My Posts" class="user-nav__link user-nav__profile-posts"><svg width="24" height="24" viewBox="0 0 24 24"><path d="M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm5 5h12v-4H9v4zm0 5h12v-4H9v4zM9 5v4h12V5H9z"/></svg><span class="user-nav__link-span">my posts</span></a>
...
<?php if ($_PAGE == "profile" && $user == strtolower(htmlspecialchars($_SESSION['username']))): ?>
<script>
