...
<div class="user-nav">
    ...
    <div class="user-nav__body">
        <a href="./u/<? // unique id here lol ?>" class="user-nav__link">my profile</a>
        <a href="./u/<? // unique id here lol ?>" class="user-nav__link">my posts</a>
        <a href="./u/<? // unique id here lol ?>/liked" class="user-nav__link">liked posts</a>
