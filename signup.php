...
<body>
    <div id="container">
        ...
        <form method="POST" action="api/account/signup.php">
            <input type="email" name="email" placeholder="Email" class="div__container__info">
            ...
            <input type="password" name="password" placeholder="Password" class="div__container__info">
