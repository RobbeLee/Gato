...
<body>
    ...
    <div class="wrapper">
        <h1> About GATO </h1>
        <p> With this page we hope to explain to you who we are, what we do, what this site is and what we hope to achieve. </p><br>
        <div class="whatIsThisSite">
            <h2>What is this site?</h2>
            <p>With Gato we hope to build a site that's easy to navigate and use. We see many social media platforms
        ...
        <div class="whatWeAchive">
            ...
            <p>We hope that we can offer you a platform where you can share your photo's easy and fast.<br>
